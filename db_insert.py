...
def insert_press_release(headline, date_str, body, a_id, filename, uname="openai"):
    try:
        ...
        (headline, content_date, body_txt, a_id, status, create_date, last_action, filename, headline2, uname)
        VALUES (%s, %s, %s, %s, %s, SYSDATE(), SYSDATE(), %s, %s, %s)
        """
